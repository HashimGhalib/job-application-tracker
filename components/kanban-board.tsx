...
import { deleteColumn } from "@/lib/actions/deleteColumn";
...
export default function KanbanBoard({ board, userId }: KanbanBoardProps) {
  ...
  async function handleDragEnd(event: DragEndEvent) {
    ...
    if (targetColumn) {
      ...
      const jobInTarget = targetColumn.jobApplications
      ...
      const allJobsInTargetFiltered = targetColumnObj.jobApplications
        .filter((j) => j._id !== activeId) || [];
